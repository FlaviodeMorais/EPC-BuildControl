...
MTO_MAP = {
    ...
    "Diâmetro 3 (pol.)":             "diameter_ter_in",
...
JOINTS_EXCEL_MAP = {
    ...
    "corrida3":         "corrida_3",
    "corrida4":         "corrida_4",
    "dtsoldr1":         "dt_soldagem_r1",
    "dtsoldr2":         "dt_soldagem_r2",
    "dtVS":             "dt_vs",
    "LP_Acab":          "lp_result_acab",
    "LP_antes_TT":      "lp_result_pre_tt",
    "dtTT":             "dt_tt",
    "dtDU":             "dt_du",
    "laudo DU":         "result_du",
    "RX_US":            "ndt_method",
